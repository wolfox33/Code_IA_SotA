...
Conteúdo referencial detalhado, schema completo e indexes estão disponíveis em:
- `references/quick-reference.md` - Quick Reference com schema completo e indexes
